...
import {DuckDbDataGetter} from '../duckdb/DuckDbDataGetter';
...
export function DataGetterProvider({children}) {
  ...
  // SERVERLESS DEMO: route data access through DuckDB-Wasm (Parquet in the
  // browser) instead of the HTTP DataGetter. Same fetchAndCacheItems surface.
  const dataGetter = new DuckDbDataGetter(dataCache);
